...
function VikingRaidFrameTearOff:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function VikingRaidFrameTearOff:Init()
    Apollo.RegisterAddon(self)
end

function VikingRaidFrameTearOff:OnSave(eType)
...
function VikingRaidFrameTearOff:OnRestore(eType, tSavedData)
...
function VikingRaidFrameTearOff:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("VikingRaidFrameTearOff.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function VikingRaidFrameTearOff:OnDocumentReady()
...
function VikingRaidFrameTearOff:Initialize(nMemberIdx)
	if self.wndMain and self.wndMain:IsValid() then
		self.wndMain:FindChild("RaidTearOffContainer"):DestroyChildren()
	else
		Apollo.StartTimer("MainUpdateTimer")
		self.wndMain = Apollo.LoadForm(self.xmlDoc, "VikingRaidFrameTearOffForm", nil, self)
...
function VikingRaidFrameTearOff:DestroyAndRedrawAllFromUI(wndHandler, wndControl)
	self.wndMain:FindChild("RaidTearOffContainer"):DestroyChildren()
...
function VikingRaidFrameTearOff:MainUpdateTimer()
...
function VikingRaidFrameTearOff:UpdateSpecificMember(nMemberIdx, tMemberData, unitTarget)
...
function VikingRaidFrameTearOff:OnCloseBtn(wndHandler, wndControl)
	if self.wndMain and self.wndMain:IsValid() then
		Apollo.StopTimer("MainUpdateTimer")
		self.wndMain:Destroy()
...
function VikingRaidFrameTearOff:OnRaidMemberUntearBtn(wndHandler, wndControl) -- RaidMemberUntearBtn
...
function VikingRaidFrameTearOff:OnRaidLockFrameBtnToggle(wndHandler, wndControl) -- RaidLockFrameBtn
...
function VikingRaidFrameTearOff:OnRaidTearMemberMouseUp(wndHandler, wndControl) -- RaidTearMember
...
function VikingRaidFrameTearOff:OnRaidMemberToTNameClick(wndHandler, wndControl) -- RaidMemberToTName
...
function VikingRaidFrameTearOff:OnEnteredCombat(unit, bInCombat)
...
function VikingRaidFrameTearOff:DoHPAndShieldResizing(wndBtnParent, unitPlayer, bBigSprites)
...
function VikingRaidFrameTearOff:LoadByName(strForm, wndParent, strCustomName)
...
local VikingRaidFrameTearOffInst = VikingRaidFrameTearOff:new()
VikingRaidFrameTearOffInst:Init()
