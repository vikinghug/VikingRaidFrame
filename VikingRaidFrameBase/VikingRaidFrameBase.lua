...
function VikingRaidFrameBase:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
...
function VikingRaidFrameBase:Init()
    Apollo.RegisterAddon(self)
end

function VikingRaidFrameBase:OnSave(eType)
...
function VikingRaidFrameBase:OnRestore(eType, tSavedData)
...
function VikingRaidFrameBase:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("VikingRaidFrameBase.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function VikingRaidFrameBase:OnDocumentReady()
	...
	self.wndMain = Apollo.LoadForm(self.xmlDoc, "VikingRaidFrameBaseForm", "FixedHudStratum", self)
...
function VikingRaidFrameBase:OnCharacterCreated()
	local unitPlayer = GameLib.GetPlayerUnit()
...
function VikingRaidFrameBase:OnRaidFrameBaseTimer()
...
function VikingRaidFrameBase:OnGroup_Join()
	if not GroupLib.InRaid() then return end
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyGeneral)
end

function VikingRaidFrameBase:OnGroup_Add(strName)
	if not GroupLib.InRaid() then return end
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyGeneral)
end

function VikingRaidFrameBase:OnGroup_Remove()
	if not GroupLib.InRaid() then return end
...
function VikingRaidFrameBase:OnGroup_Left()
	if not GroupLib.InRaid() then return end
...
function VikingRaidFrameBase:OnGroup_Updated()
	if not GroupLib.InRaid() then return end
	--self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyGeneral)
end

function VikingRaidFrameBase:OnGroup_MemberFlagsChanged(nMemberIdx, bFromPromotion, tChangedFlags)
	if not GroupLib.InRaid() then return end
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyGeneral)
end

function VikingRaidFrameBase:OnGroup_LootRulesChanged()
	if not GroupLib.InRaid() then return end
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyLootRules)
end

function VikingRaidFrameBase:OnGroup_FlagsChanged()
	if not GroupLib.InRaid() then return end
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyGeneral)
end

function VikingRaidFrameBase:BuildAllFrames()
...
function VikingRaidFrameBase:UpdateLootRules()
...
function VikingRaidFrameBase:UpdateMemberFrame(tCategory, tCurrMemberList, strCategory)
	local wndCategory = tCategory.wnd
	local wndRaidCategoryItems = tCategory.wndRaidCategoryItems
...
function VikingRaidFrameBase:UpdateAllMembers()
	local nGroupMemberCount = GroupLib.GetMemberCount()
	local nInvalidOrDeadMembers = 0
...
function VikingRaidFrameBase:UpdateOffsets()
...
function VikingRaidFrameBase:ResizeAllFrames()
	self:UpdateOffsets()
...
function VikingRaidFrameBase:ResizeMemberFrame(wndRaidMember)
...
function VikingRaidFrameBase:UpdateRaidOptions(nCodeIdx, tMemberData)
...
function VikingRaidFrameBase:UpdateSpecificMember(tRaidMember, nCodeIdx, tMemberData, nGroupMemberCount, bFrameLocked)
...
function VikingRaidFrameBase:OnTargetUnitChanged(unitOwner)
...
function VikingRaidFrameBase:OnRaidCategoryBtnToggle(wndHandler, wndControl) -- RaidCategoryBtn
...
function VikingRaidFrameBase:OnRaidLeaderOptionsToggle(wndHandler, wndControl) -- RaidLeaderOptionsBtn
...
function VikingRaidFrameBase:OnRaidMasterLootToggle(wndHandler, wndControl) -- RaidMasterLootBtn
...
function VikingRaidFrameBase:OnRaidConfigureToggle(wndHandler, wndControl) -- RaidConfigureBtn
...
function VikingRaidFrameBase:OnRaidTearOffBtn(wndHandler, wndControl) -- RaidTearOffBtn
...
function VikingRaidFrameBase:OnRaidUnTearOff(wndArg) -- GenericEvent_Raid_ToggleRaidUnTear
	self.tTearOffMemberIDs[wndArg] = nil
end

function VikingRaidFrameBase:OnLeaveBtn(wndHandler, wndControl)
	self:OnUncheckLeaderOptions()
	self:OnUncheckMasterLoot()
	GroupLib.LeaveGroup()
end

function VikingRaidFrameBase:OnRaidLeaveShowPrompt(wndHandler, wndControl)
...
function VikingRaidFrameBase:OnRaidLeaveYes(wndHandler, wndControl)
	wndHandler:GetParent():Destroy()
	self:OnLeaveBtn()
end

function VikingRaidFrameBase:OnRaidLeaveNo(wndHandler, wndControl)
	wndHandler:GetParent():Destroy()
end

function VikingRaidFrameBase:OnUncheckLeaderOptions()
	if self.wndMain and self.wndMain:IsValid() then
		self.wndRaidLeaderOptionsBtn:SetCheck(false)
	end
end

function VikingRaidFrameBase:OnUncheckMasterLoot()
	if self.wndMain and self.wndMain:IsValid() then
		self.wndRaidMasterLootBtn:SetCheck(false)
	end
end

function VikingRaidFrameBase:OnGroupBagBtn()
	Event_FireGenericEvent("GenericEvent_ToggleGroupBag")
end

function VikingRaidFrameBase:OnMasterLootUpdate()
...
function VikingRaidFrameBase:OnRaidWrongInstance()
...
function VikingRaidFrameBase:OnStartReadyCheckBtn(wndHandler, wndControl) -- StartReadyCheckBtn
...
function VikingRaidFrameBase:OnGroup_ReadyCheck(nMemberIdx, strMessage)
...
function VikingRaidFrameBase:OnReadyCheckResponse(wndHandler, wndControl)
...
function VikingRaidFrameBase:OnReadyCheckTimeout()
...
function VikingRaidFrameBase:OnConfigSetAsDPSToggle(wndHandler, wndControl)
	GroupLib.SetRoleDPS(wndHandler:GetData(), wndHandler:IsChecked()) -- Will fire event Group_MemberFlagsChanged
end

function VikingRaidFrameBase:OnConfigSetAsTankToggle(wndHandler, wndControl)
	GroupLib.SetRoleTank(wndHandler:GetData(), wndHandler:IsChecked()) -- Will fire event Group_MemberFlagsChanged
end

function VikingRaidFrameBase:OnConfigSetAsHealerToggle(wndHandler, wndControl)
	GroupLib.SetRoleHealer(wndHandler:GetData(), wndHandler:IsChecked()) -- Will fire event Group_MemberFlagsChanged
end

function VikingRaidFrameBase:OnRaidMemberBtnClick(wndHandler, wndControl) -- RaidMemberMouseHack
...
function VikingRaidFrameBase:OnRaidLockFrameBtnToggle(wndHandler, wndControl) -- RaidLockFrameBtn
...
function VikingRaidFrameBase:OnRaidCustomizeNumColAdd(wndHandler, wndControl) -- RaidCustomizeNumColAdd, and once from bSwapToTwoColsOnce
...
function VikingRaidFrameBase:OnRaidCustomizeNumColSub(wndHandler, wndControl) -- RaidCustomizeNumColSub
	self.nNumColumns = self.nNumColumns - 1
...
function VikingRaidFrameBase:OnRaidCustomizeRowSizeAdd(wndHandler, wndControl) -- RaidCustomizeRowSizeAdd
...
function VikingRaidFrameBase:OnRaidCustomizeRowSizeSub(wndHandler, wndControl) -- RaidCustomizeRowSizeSub
	self.nRowSize = self.nRowSize - 1
...
function VikingRaidFrameBase:DestroyAndRedrawAllFromUI(wndHandler, wndControl) -- RaidCustomizeRoleIcons
	self:OnDestroyAndRedrawAll()
end

function VikingRaidFrameBase:OnDestroyAndRedrawAll() -- DestroyAndRedrawAllFromUI
	if self.wndMain and self.wndMain:IsValid() then
		self.wndRaidCategoryContainer:DestroyChildren()
		self:OnRaidFrameBaseTimer()
...
function VikingRaidFrameBase:DestroyMemberWindows(nMemberIdx)
...
function VikingRaidFrameBase:OnRaidWindowSizeChanged(wndHandler, wndControl)
	if wndHandler ~= wndControl then
		return
	end
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyResize)
...
function VikingRaidFrameBase:OnEnteredCombat(unit, bInCombat)
...
function VikingRaidFrameBase:HelperVerifyMemberCategory(strCurrCategory, tMemberData)
	local bResult = true
...
function VikingRaidFrameBase:DoHPAndShieldResizing(tRaidMember, unitPlayer)
...
function VikingRaidFrameBase:FactoryMemberWindow(wndParent, strKey)
...
function VikingRaidFrameBase:FactoryCategoryWindow(wndParent, strKey)
	if self.cache == nil then
		self.cache = {}
	end
...
---------------------------------------------------------------------------------------------------
-- VikingRaidFrameBaseForm Functions
---------------------------------------------------------------------------------------------------

function VikingRaidFrameBase:OnRaidCustomizeCategoryCheck(wndHandler, wndControl, eMouseButton)
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyGeneral, knDirtyResize)
end

function VikingRaidFrameBase:OnRaidCustomizeShowNamesCheck(wndHandler, wndControl, eMouseButton)
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyMembers)
end

function VikingRaidFrameBase:OnRaidCustomizeDirtyMembers(wndHandler, wndControl, eMouseButton)
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyMembers)
end

function VikingRaidFrameBase:OnRaidCustomizeClassIconsCheck(wndHandler, wndControl, eMouseButton)
	self.nDirtyFlag = bit32.bor(self.nDirtyFlag, knDirtyMembers, knDirtyResize)
end

local VikingRaidFrameBaseInst = VikingRaidFrameBase:new()
VikingRaidFrameBaseInst:Init()
